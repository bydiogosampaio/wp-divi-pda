...
<script type="text/javascript">
    jQuery( '.markdown-body a.anchor, a[href*="#"]:not([href="#"]), a[href="#"]' ).unbind( 'click' );
    jQuery( '.markdown-body a.anchor, a[href*="#"]:not([href="#"]), a[href="#"]' ).off( 'click' );
    // jQuery( '.markdown-body a.anchor' ).click( 'click' );
</script>
<script type="text/javascript">
  var _paq = _paq || [];
